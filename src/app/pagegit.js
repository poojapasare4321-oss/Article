          ...
          <div className="hidden sm:block absolute top-0 left-0 right-0 z-10 overflow-hidden">
            <div className="bg-white border border-black shadow-lg overflow-hidden rounded-2xl md:rounded-t-3xl min-h-[320px] md:min-h-[360px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                ...
                {/* LEFT */}
                {/* <div className="p-3 sm:p-4 md:p-6 pb-16 sm:pb-16 md:pb-14 relative flex flex-col h-full"> */}
                {/* <div className="p-3 sm:p-4 md:p-6 pb-0 relative flex flex-col h-full justify-between"> */}
                {/* <div className="p-3 sm:p-4 md:p-6 pb-20 md:pb-16 relative flex flex-col h-full"> */}
<div className="px-8 pt-8 pb-8 md:px-12 md:pt-12 md:pb-12 flex flex-col h-full">

  {/* TEXT AREA */}
  <div className="flex-1 flex items-start">
    <p className="text-[12px] sm:text-[14px] md:text-base leading-relaxed text-gray-800 line-clamp-4 md:line-clamp-5">
      {visibleCards[0].excerpt?.replace(/\.{3,}$/, "")}
    </p>
  </div>

  {/* AUTHOR — PERFECT BOTTOM LEFT */}
  <div className="mt-8 flex items-center gap-3">
    
    <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white text-xs md:text-sm font-semibold">
      {(visibleCards[0].author?.name || "A").charAt(0)}
    </div>
    ...
    <div className="leading-tight">
      ...
      <p className="text-[10px] md:text-xs text-gray-500">
        {visibleCards[0].author?.role || "Healthcare"}
                ...
                {/* IMAGE */}
                {/* <div className="h-[200px] sm:h-[220px] md:h-full overflow-hidden rounded-t-[40px] md:rounded-l-[120px]"> */}
                {/* <div className="h-[200px] sm:h-[220px] flex overflow-hidden md:h-full md:self-stretch overflow-hidden rounded-t-[40px] md:rounded-l-[120px]">
                  <img
                    src={visibleCards[1].featuredImage || "/default-blog.jpg"}
                    alt={visibleCards[1].title}
                    className="w-full h-full object-cover"
                ...
                <div className="hidden md:block absolute top-0 right-0 h-full w-1/2 overflow-hidden rounded-l-[120px]">
  <img
    src={visibleCards[0].featuredImage || "/default-blog.jpg"}
    alt={visibleCards[0].title}
    className="w-full h-full object-cover"
